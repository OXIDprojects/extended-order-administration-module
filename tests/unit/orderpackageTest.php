...
/**
 * Testing oeExtendedOrderAdminOrderPackage class
 */
class oeExtendedOrderAdminOrderPackageTest extends OxidTestCase
{
    ...
    public function testRender()
    {
        ...
        $oView = oxNew('oeExtendedOrderAdminOrderPackage');
        $this->assertEquals("oeextendedorderadminorderpackage.tpl", $oView->render());
