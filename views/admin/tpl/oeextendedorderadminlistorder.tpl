...
<form name="transfer" id="transfer" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <input type="hidden" name="cl" value="oeextendedorderadminlistorder">
    ...
    <form name="showlist" id="showlist" action="[{$oViewConf->getSelfLink()}]" method="post">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr>
                ...
                <td class="listheader first"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, '', 'oxorderdate', 'desc');document.forms.showlist.submit();" class="listheader">[{oxmultilang ident="OEEXTENDEDORDERADMIN_OXORDERDATE"}]</a></td>
                <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxorderarticles', 'oxartnum', 'asc');document.forms.showlist.submit();" class="listheader">[{oxmultilang ident="OEEXTENDEDORDERADMIN_OXARTNUM"}]</a></td>
                <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, '', 'oxorderamount', 'asc');document.forms.showlist.submit();" class="listheader">[{oxmultilang ident="OEEXTENDEDORDERADMIN_SUM"}]</a></td>
                <td class="listheader"><a href="javascript:top.oxid.admin.setSorting( document.forms.showlist, 'oxorderarticles', 'oxtitle', 'asc');document.forms.showlist.submit();" class="listheader">[{oxmultilang ident="OEEXTENDEDORDERADMIN_OXTITLE"}]</a></td>
...
<script type="text/javascript">
    ...
    {   parent.parent.sShopTitle   = "[{$actshopobj->oxshops__oxname->getRawValue()|oxaddslashes}]";
        ...
        parent.parent.sMenuSubItem = "[{oxmultilang ident="OEEXTENDEDORDERADMIN_HEADER"}]";
